...
urlpatterns = [
    ...
    path('workout/(?P<id>\d*)/exercise', views.exercise,name='add-exercise'), # add exercise
    path('workout/(?P<id>\d*)/complete', views.complete_workout,name='complete-workout'), # complete workout
    path('workout/(?P<id>\d*)/edit', views.edit_workout,name='edit-workout'), # edit workout
    path('workout/(?P<id>\d*)/delete', views.delete_workout,name='delete-workout'), # delete workout
